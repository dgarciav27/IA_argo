...
loads splits from argo_preprocess.py output.
Optimize F1-macro in HalvingRandomSearchCV, then does threshold tuning in val and evaluation in test.

To run after:
  /home/drgarcia/IA_argo/1.Preprocess_ML/preprocessing.ipynb
"""
...
# PATHS 
PREPROCESS_DIR = "/work/drgarcia/Dataset/pacific_ocean/preprocessed/split_time_ascA"
OUTPUT_DIR     = "/home/drgarcia/Argo_ml_code/Models_and_results/XG_boost/pacific_f1macro_time_asc_nounder"
...
experiment_name = "XGBoost_Pacific_TemporalSplit"
...
# TRAINING 
with mlflow.start_run(run_name="XGBoost_f1_time_ascD_nounder"):
    ...
    def _save_report():
        ...
        with open(path, "w") as f:
            f.write("XGBoost — Time split | Ascending only | Not undersampled | scoring=f1_macro \n")
            f.write("=" * 70 + "\n\n")
